...
GEN_AI_PROMOTED_KEYS = frozenset({
    ...
    # Column-name keys set by SDK enrichment via overridable-keys path.
    # Promoted to prevent duplication in metadata. These are serialized
    # into the S3 log object via RespanTextLogParams.serialize_for_logging().
    "tools",
    "response_format",
